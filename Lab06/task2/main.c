...
void Thread1 (void const *argument)
{
    for (;;)
    {
        ...
        switch(userInput)
        {
            case '1':    //if character '1' is received, put system into normal mode
                osSignalSet    (T_Thread2,0x01);
                osSignalSet    (T_Thread3,0x02);
            break;
            case '0':    //if character '0' is received, put system into override mode
                osSignalSet    (T_Thread3,0x01);
                osSignalSet    (T_Thread2,0x02);
            break;
            default:    //if any other character is received, put system into idle mode
                osSignalSet    (T_Thread2,0x02);
              osSignalSet    (T_Thread3,0x02);
            break;
        }
...
void Thread2 (void const *argument)
{
    ...
    for (;;)
    {
        //check latest signal and set state accordingly
        ...
        switch(state)
        {
            case 1:        //get mutex and run through sequence
